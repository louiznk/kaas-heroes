...
function resolve(issuesResolved, difficulty, coins = 0) {
    ...
    finalScore.innerHTML = `Félicitation, vous avez résolu ${issues} issues et ${storyPoints} story points.<br />Vous finissez l'aventure avec le niveau ${newLevel} et ${money} pièces d'or.`
